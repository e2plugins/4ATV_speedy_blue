...
class speedyredtestflipclock_metall1(Renderer):
    ...
    def changed(self, what):
        if not self.suspended:
            ...
            if 'H1' in value:
                ...
                value = 0
            self.instance.setPixmapFromFile('/usr/share/enigma2/atv_speedy_red/flipclock/flipclock_metall1/' + str(value) + '.png')
