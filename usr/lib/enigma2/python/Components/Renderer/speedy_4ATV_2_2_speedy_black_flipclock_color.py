...
class speedy_4ATV_2_2_speedy_black_flipclock_color(Renderer):
    ...
    def changed(self, what):
        if not self.suspended:
            ...
            if 'H1' in value:
                ...
                value = 0
            self.instance.setPixmapFromFile('/usr/share/enigma2/4ATV_2_2_speedy_black/flipclock/flipclock_color/' + str(value) + '.png')
