# Embedded file name: /usr/lib/enigma2/python/Components/Converter/blueAudioInfo.py
...
class speedy2AudioInfo(Poll, Converter, object):
    GET_AUDIO_ICON = 0
    GET_AUDIO_CODEC = 1
    ...
    def __init__(self, type):
        ...
        self.codecs = {'01_dolbydigitalplus': ('digital+', 'digitalplus'),
         '02_ac3+': ('ac3+', 'e-ac-3'),
         '03_ac3': ('ac3', 'ac-3'),
         '04_dolbydigital': ('dolbydigital',),
         '05_mp3': ('mp3',),
         '06_wma': ('wma',),
         '07_x-raw': ('audio/x-raw',),
         '08_flac': ('flac',),
         '09_he-aac': ('he-aac',),
         '10_aac': ('aac', 'mpeg-4 aac', 'mpeg-4'),
         '11_lpcm': ('lpcm',),
         '12_dts-hd': ('dts-hd',),
         '13_dts': ('dts',),
         '14_pcm': ('pcm',),
