...
class speedyvioletflipclock_metall1(Renderer):
    ...
    def changed(self, what):
        if not self.suspended:
            ...
            if 'H1' in value:
                ...
                value = 0
            self.instance.setPixmapFromFile('/usr/share/enigma2/4ATV_2_2_speedy_violet_mod/flipclock/flipclock_metall1/' + str(value) + '.png')
