# Embedded file name: /usr/lib/enigma2/python/Components/Converter/Kitte888TestConnectionRouter.py
# in pause die zeit eintragen fuer den ping in host ip adresse und in port den port dazu alles fuer den router
...
class speedyTestConnectionRouter(Converter, object):
